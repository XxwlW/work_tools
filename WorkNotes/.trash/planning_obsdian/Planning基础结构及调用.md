...
![](planning_obsdian/planning_obsdian.assets/20250612-3.png)
...
目录：./src/tasks/
![](planning_obsdian/planning_obsdian.assets/20250515.png)

task 目录下为不同的 task

### Task 类

**![](planning_obsdian/planning_obsdian.assets/20250515-4.png)**
...
![](planning_obsdian/planning_obsdian.assets/20250519-2.png)
...
如：`scenarios/park/valet_parking` 为例子：
 ...
 ![](planning_obsdian/planning_obsdian.assets/20250519-1.png)
 该场景有两个 stage: `VALET_PARKING_APPROACHING_PARKING_SPOT`  `VALET_PARKING_PARKING`
 两个 stage 均继承与 Stage 类
 ![](planning_obsdian/planning_obsdian.assets/20250519-5.png)
 stage_parking.h 定义 stage VALET_PARKING_PARKING
 ![](planning_obsdian/planning_obsdian.assets/20250519-6.png)
...
目录：./src/scenarios/
![](planning_obsdian/planning_obsdian.assets/20250515-1.png)
...
流程图如下：
![](planning_obsdian/planning_obsdian.assets/20250519-7.png)
...
![](planning_obsdian/planning_obsdian.assets/20250616-1.png)
...
![](planning_obsdian/planning_obsdian.assets/20250519-10.png)

![](planning_obsdian/planning_obsdian.assets/20250519-11.png)
...
![](planning_obsdian/planning_obsdian.assets/20250519-12.png)
...
![](planning_obsdian/planning_obsdian.assets/20250519-13.png)
在 PlanningComponent:: Proc()中，调用了 PlanningBase 类的 RunOnce 函数。根据继承与虚函数的多态特性，相对应的 planning 流程和 planner 会执行具体的规划任务。

![](planning_obsdian/planning_obsdian.assets/20250519-14.png)
...
![](planning_obsdian/planning_obsdian.assets/20250725.png)
...
![](planning_obsdian/planning_obsdian.assets/20250528-1.png)
![](planning_obsdian/planning_obsdian.assets/20250528-2.png)


## CalSlotEntranceToAroundObsDis()

计算障碍物到入口两侧边界线的最小距离
![](planning_obsdian/planning_obsdian.assets/20250709.png)
...
![](planning_obsdian/planning_obsdian.assets/20250528.png)
...
![](planning_obsdian/planning_obsdian.assets/20250715.png)
...
2. 获取规划相关数据
 `frame_->planning_start_point_`
    初始值为世界坐标系下的车辆起始位置
    ![](planning_obsdian/planning_obsdian.assets/20250529-1.png)
    ![](planning_obsdian/planning_obsdian.assets/20250529-2.png)
...
5. `DesignSensitiveAreas()`
 敏感区域设定：
    ...
    ![](planning_obsdian/planning_obsdian.assets/20250530.png)
...
![](planning_obsdian/planning_obsdian.assets/20250603.png)
...
![](planning_obsdian/planning_obsdian.assets/20250715-3.png)
![](planning_obsdian/planning_obsdian.assets/20250715-2.png)
...
![](planning_obsdian/planning_obsdian.assets/20250616.png)
